...
urlpatterns = [
    ...
    path('gestionnaire/etudiants/modifier/<int:id>/', views.modifier_etudiant, name='modifier_etudiant'),
    path('gestionnaire/etudiants/supprimer/<int:id>/', views.supprimer_etudiant, name='supprimer_etudiant'),
    ...
    path('gestionnaire/generate_transcript/<int:id>/', views.generate_transcript, name='generate_transcript'),
]
